return {
  ...
  keys = {
    ...
    { '<leader>f.', function() require('fzf-lua').oldfiles() end,           desc = 'Find Recent Files' },
    --- other
    ...
    { '<leader>fa', function() require('fzf-lua').lsp_code_actions() end,   desc = 'Find [code] Actions' },
    --- search
    { '<leader>sc', function() require('fzf-lua').commands() end,           desc = 'Search Commands' },
    { '<leader>sC', function() require('fzf-lua').command_history() end,   desc = 'Search Commands History' },
    { '<leader>sg', function() require('fzf-lua').live_grep() end,          desc = 'Search [by] Grep' },
    { '<leader>sw', function() require('fzf-lua').grep_cword() end,         desc = 'Search [by] Word' },
